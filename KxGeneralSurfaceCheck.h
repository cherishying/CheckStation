...
#ifndef _KXGENERALSURFACECHECKH
#define _KXGENERALSURFACECHECKH
...
class CKxGeneralSurfaceCheck
{
public:
	CKxGeneralSurfaceCheck();
	~CKxGeneralSurfaceCheck();
...
public:
	...
	int  ConvertSliderCc(const kxCImageBuf& SrcImg, kxCImageBuf& DstImg, int nDirection, KxCallStatus& hCall);
