...
#ifndef _KXIMAGEMASKHHHH
#define _KXIMAGEMASKHHHH

//add by lyl 2016/6/14
...
public:
	...
	struct Parameter
	{
		Parameter()
		{
			memcpy(m_szVersion, "ImageMask1.0", _VersionNameLen);
		...
		kxRect<int>       m_rcMask[_Max_Mask]; 	         //掩模区域数据，_MaskCount = 8
